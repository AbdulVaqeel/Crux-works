...
// //   id: string;
// //   title: string;
// //   type: "nps" | "multiple-choice" | "csat" | "ces" | "barchart" | "linechart";
...
// //   // Show real data only when correct survey + correct date range is selected
...
// //     // For Product and Services → show ONLY charts
// //     if (survey === "Product and Services") {
// //       questions = questions.filter(q => q.type === "barchart" || q.type === "linechart");
// //     }

// //     return {
// //       stats: surveyData[survey].stats,
// //       questions,
// //     };
// //   }, [showRealData, survey]);
...
// //   /* ==================== QUESTION RENDERERS (EXACT SAME DESIGN) ==================== */
...
// //   id: string;
// //   title: string;
// //   type: "nps" | "multiple-choice" | "csat" | "ces" | "barchart" | "linechart" | "piechart";
...
// //     stats: { total: 1034, notStarted: 695, partiallyCompleted: 2, completed: 337 },
// //     questions: [
// //       { id: "q6", title: "Q6: Daily User Activity (Last 7 Days)", type: "barchart" },
// //       { id: "q7", title: "Q7: Monthly Active Users vs Page Views", type: "linechart" },
// //       { id: "q8", title: "Q8: User Distribution by Region", type: "piechart" },
// //     ],
// //   },
// // };
...
// //   const { stats, questions } = useMemo(() => {
// //     if (!showRealData || !surveyData[survey]) {
// //       return { stats: zeroStats, questions: [] };
// //     }
// //     return { stats: surveyData[survey].stats, questions: surveyData[survey].questions };
// //   }, [showRealData, survey]);
...
// //     // Multiple Choice, CSAT, CES — exactly as before
// //     if (q.type === "multiple-choice" && q.answers && q.progress) {
// //       return (
// //         <Card key={q.id} sx={{ borderRadius: 2, boxShadow: 1, mt: 2 }}>
// //           <CardContent sx={{ p: 4 }}>
...
// //               {q.answers.map((item, idx) => (
// //                 <Box key={idx} sx={{ display: "flex", justifyContent: "space-between", py: 2.5, borderBottom: idx < q.answers!.length - 1 ? "1px solid #e0e0e0" : "none" }}>
// //                   <Typography sx={{ color: "#333" }}>{item.answer}</Typography>
// //                   <Box sx={{ display: "flex", gap: 8 }}>
// //                     <Typography sx={{ minWidth: 60, textAlign: "center" }}>{item.count}</Typography>
// //                     <Typography sx={{ minWidth: 50, textAlign: "center", fontWeight: 500 }}>{item.percentage}</Typography>
...
// //                   const hoverKey = idx + q.id.charCodeAt(0);
// //                   return (
// //                     <Box key={idx} sx={{ display: "flex", alignItems: "center", mb: 4, gap: 2 }} onMouseEnter={() => setHoveredIndex(hoverKey)} onMouseLeave={() => setHoveredIndex(null)}>
// //                       <Typography sx={{ minWidth: 180, fontWeight: 500, color: "#555" }}>{item.label}</Typography>
// //                       <Box sx={{ flex: 1, position: "relative" }}>
// //                         <Box sx={{ height: 32, bgcolor: "#f5f5f5", borderRadius: 1, overflow: "hidden" }}>
// //                           <Box sx={{ width: `${item.percentage}%`, height: "100%", bgcolor: item.color, transition: "all 0.3s ease" }} />
// //                         </Box>
// //                         {hoveredIndex === hoverKey && (
// //                           <Box sx={{ position: "absolute", right: -50, top: "50%", transform: "translateY(-50%)", bgcolor: item.color, color: "white", px: 1.5, py: 0.5, fontWeight: 600, borderRadius: 1, fontSize: "0.9rem" }}>
// //                             {item.percentage}%
// //                           </Box>
// //                         )}
// //                       </Box>
...
// //                   <Typography variant="h3" sx={{ fontSize: "3rem", fontWeight: 600 }}>{q.score}</Typography>
// //                   <Typography variant="body2" sx={{ color: "#666" }}>{q.total} total responses</Typography>
// //                   <Box sx={{ bgcolor: "#666", color: "white", px: 1.5, py: 0.3, borderRadius: 1, mt: 1, fontSize: "0.75rem", display: "inline-block" }}>
// //                     {q.badge}
// //                   </Box>
// //                 </Box>
// //                 <Box sx={{ flex: 1 }}>
...
// //                             <Box sx={{ width: `${perc}%`, height: "100%", bgcolor: r.color, transition: "width 0.4s ease" }} />
// //                           </Box>
// //                           <Typography sx={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", fontWeight: 700, fontSize: "0.9rem", color: "#333" }}>
// //                             {r.count}
// //                           </Typography>
// //                         </Box>
// //                       </Box>
...
// //               <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose} MenuListProps={{ sx: { py: 1 } }}>
// //                 <MenuItem onClick={handleMenuClose}>
// //                   <ArrowDownwardIcon sx={{ mr: 1 }} /> PPT
// //                 </MenuItem>
// //                 <MenuItem onClick={handleMenuClose}>
...
//   id: string;
//   title: string;
//   type: "nps" | "multiple-choice" | "csat" | "ces" | "barchart" | "linechart" | "piechart" | "treemap";
...
//       { id: "q7", title: "Q7: Monthly Active Users vs Page Views", type: "linechart" },
//       { id: "q8", title: "Q8: User Distribution by Region", type: "piechart" },
//       { id: "q9", title: "Q9: Codebase Structure Overview", type: "treemap" },
//     ],
//   },
// };
...
//   // Treemap with beautiful custom styling
//   const renderTreemap = () => (
//     <Card sx={{ borderRadius: 2, boxShadow: 1, mt: 4 }}>
//       <CardContent sx={{ p: 4 }}>
//         <Typography variant="subtitle1" sx={{ mb: 3, fontWeight: 600, color: "#333" }}>
...
//   // Custom Treemap Cell for beautiful colors and labels
...
//     // Multiple-choice, CSAT, CES — unchanged (same as before)
//     if (q.type === "multiple-choice" && q.answers && q.progress) {
//       return (
//         <Card key={q.id} sx={{ borderRadius: 2, boxShadow: 1, mt: 2 }}>
//           <CardContent sx={{ p: 4 }}>
...
//               </IconButton>
//               <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose} MenuListProps={{ sx: { py: 1 } }}>
//                 <MenuItem onClick={handleMenuClose}><ArrowDownwardIcon sx={{ mr: 1 }} /> PPT</MenuItem>
//                 <MenuItem onClick={handleMenuClose}><ArrowDownwardIcon sx={{ mr: 1 }} /> PDF</MenuItem>
//               </Menu>
//             </Box>
//           </Box>
//         </Box>
...
//                 <FormControl fullWidth>
//                   <InputLabel id="survey-select-label">Survey</InputLabel>
//                   <Select labelId="survey-select-label" value={survey} label="Survey" onChange={handleSurveyChange}>
//                     <MenuItem value="Customer Satisfaction">Customer Satisfaction</MenuItem>
//                     <MenuItem value="Product and Services">Product and Services</MenuItem>
//                   </Select>
//                 </FormControl>
...
//             { title: "COMPLETED", value: stats.completed, bg: "#4CAF50" },
//           ].map((card, i) => (
//             <Box key={i} sx={{ flex: 1, bgcolor: card.bg, color: card.color || "white", textAlign: "center", py: 2 }}>
//               <Typography variant="body2" sx={{ textTransform: "uppercase", fontWeight: 300, mb: 1 }}>{card.title}</Typography>
//               <Typography variant="h4" sx={{ fontWeight: 300 }}>{card.value}</Typography>
//             </Box>
//           ))}
//         </Box>
...
// // Scatter Chart Data (your original)
// const scatterData01 = [
//   { x: 100, y: 200, z: 200 },
//   { x: 120, y: 100, z: 260 },
//   { x: 170, y: 300, z: 400 },
...
//   id: string;
//   title: string;
//   type: "nps" | "multiple-choice" | "csat" | "ces" | "barchart" | "linechart" | "piechart" | "treemap" | "scatter";
//   npsScore?: number;
//   detractors?: string;
//   passives?: string;
//   promoters?: string;
...
//       { id: "q8", title: "Q8: User Distribution by Region", type: "piechart" },
//       { id: "q9", title: "Q9: Codebase Structure Overview", type: "treemap" },
//       { id: "q10", title: "Q10: Student Performance Comparison (Height vs Weight vs Score)", type: "scatter" },
//     ],
//   },
// };
...
//   /* ==================== CHART RENDERERS ==================== */
//   const renderBarChart = () => (/* unchanged - same as before */);
//   const renderLineChart = () => (/* unchanged - same as before */);
//   const renderPieChart = () => (/* unchanged - same as before */);

//   // Treemap (Q9) - unchanged
//   const renderTreemap = () => (
//     <Card sx={{ borderRadius: 2, boxShadow: 1, mt: 4 }}>
//       <CardContent sx={{ p: 4 }}>
//         <Typography variant="subtitle1" sx={{ mb: 3, fontWeight: 600, color: "#333" }}>
...
//               content={<CustomizedContent />}
//             >
//               <Tooltip contentStyle={{ backgroundColor: "rgba(0,0,0,0.85)", color: "white", border: "none", borderRadius: 8 }}
//                 formatter={(value: any) => `${value} lines`} />
//             </Treemap>
//           </ResponsiveContainer>
//         </Box>
...
//   const CustomizedContent = (props: any) => { /* unchanged - same as before */ };
...
//     if (q.type === "piechart") return renderPieChart();
//     if (q.type === "treemap") return renderTreemap();
//     if (q.type === "scatter") return renderScatterChart(); // Q10

//     // ... all your other renderers (nps, multiple-choice, csat, ces) remain 100% unchanged
...
//     <LocalizationProvider dateAdapter={AdapterDayjs}>
//       <Box sx={{ p: 3, mt: -8.9, bgcolor: "#f5f6f9", minHeight: "100vh", fontFamily: "'Roboto', sans-serif" }}>
//         {/* Header, Filters, Stats Bar - unchanged */}
//         {/* ... your existing JSX ... */}
...
const AnalyzeAnswers: React.FC = () => {
  ...
  const currentData = useMemo(() => {
    ...
    // For Product and Services → show ONLY charts
    if (survey === "Product and Services") {
      questions = questions.filter(q => q.type === "barchart" || q.type === "linechart" || q.type === "piechart" || q.type === "treemap" || q.type === "scatter");
    }
    return {
      stats: surveyData[survey].stats,
      questions,
